...
df = pd.read_csv('C:/Users/mayugam info/python/Face login/Profile.csv')
df.sort_values('Ids', inplace = True)
df.drop_duplicates(subset = 'Ids', keep = 'first', inplace = True)
df.to_csv('C:/Users/mayugam info/python/Face login/Profile.csv', index = False)

# Fuction to detect the face
def DetectFace():
    reader = csv.DictReader(open('C:/Users/mayugam info/python/Face login/Profile.csv'))
    ...
    recognizer.read("C:/Users/mayugam info/python/Face login/TrainData/Trainner.yml")
    harcascadePath = "C:/Users/mayugam info/python/Face login/hh.xml"
