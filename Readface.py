...
def TakeImages():
    ...
    if (name.isalpha() and is_number(Id)):
        ...
        if Id == '1':
            fieldnames = ['Name','Ids']
            with open('C:/Users/mayugam info/python/Face login/Profile.csv','w') as f:
                writer = csv.DictWriter(f, fieldnames =fieldnames)
                writer.writeheader()
                writer.writerow(dict1)
        else:
            fieldnames = ['Name','Ids']
            with open('C:/Users/mayugam info/python/Face login/Profile.csv','a+') as f:
                writer = csv.DictWriter(f, fieldnames =fieldnames)
                #writer.writeheader()
                writer.writerow(dict1)
        ...
        harcascadePath = "C:/Users/mayugam info/python/Face login/haarcascade_frontalface_default.xml"
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite("C:/Users/mayugam info/python/Face login/TrainingImage\ " + name + "." + Id + '.' + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                # display the frame
